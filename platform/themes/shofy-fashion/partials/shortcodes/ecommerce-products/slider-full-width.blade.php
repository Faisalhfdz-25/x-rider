                        ...
                        <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                            ...
                            <div class="tp-featured-content">
                                ...
                                <div class="tp-featured-price-wrapper">
                                    <span class="tp-featured-price new-price">{{ format_price($product->front_sale_price_with_taxes) }}</span>
                                    @if($product->isOnSale())
                                        <span class="tp-featured-price old-price">{{ format_price($product->price_with_taxes) }}</span>
                                    @endif
                                </div>
