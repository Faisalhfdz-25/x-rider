        ...
        @if (EcommerceHelper::isWishlistEnabled())
            <div class="tp-header-action-item d-none d-lg-block">
                <a href="{{ route('public.wishlist') }}" class="tp-header-action-btn">
                    ...
                    <span class="tp-header-action-badge" data-bb-value="wishlist-count">{{ auth('customer')->check()? auth('customer')->user()->wishlist()->count(): Cart::instance('wishlist')->count() }}</span>
                </a>
            </div>
        @endif
